...
from keranjang.views import checkout, update_quantity_ajax, remove_from_cart_ajax, get_user_cart, add_to_cart,view_keranjang, show_json, show_xml, show_json_by_id, show_xml_by_id
from django.urls import path
